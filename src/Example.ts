...
/**
 * Constructor for a new <code>fontawesome.icons.lib.Example</code> control.
 *
 ...
 * @constructor
 * @public
 * @name fontawesome.icons.lib.Example
 */
export default class Example extends Control {
	...
	static readonly metadata: MetadataOptions = {
		...
		properties: {
			 ...
			 */
			color: {
				type: "fontawesome.icons.lib.ExampleColor",
				group: "Appearance",
